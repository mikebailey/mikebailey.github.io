...
export function createServer(env){
 const server=new McpServer({name:'michael-bailey',version:'1.1.0'},{instructions});
...
export default {async fetch(request,env){
 ...
 if(path==='/mcp/health')return wrap(Response.json({status:'ok',service:'michael-bailey-mcp',version:'1.1.0',access:'agents only'}));
